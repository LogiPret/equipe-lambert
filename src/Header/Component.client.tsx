...
export const HeaderClient: React.FC<HeaderClientProps> = ({ data }) => {
  ...
  return (
    <header
      className={`${isHomePage ? 'sticky top-0 sm:absolute sm:top-0 sm:left-0 sm:right-0 z-50 bg-branding100 sm:bg-transparent w-full max-w-full pb-2' : 'container relative z-20'}`}
      ...
      >
        <Link href="/">
          <Logo
            ...
            className={`${
              isHomePage
                ? 'drop-shadow-lg filter brightness-100 sm:invert invert-0'
